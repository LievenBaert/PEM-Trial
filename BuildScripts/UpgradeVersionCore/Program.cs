...
namespace UpgradeVersion
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string jsonFile, Version;
            Console.WriteLine("Retrieving args");          
            RetrieveArguments( args, out jsonFile, out Version);
        ...
        private static void RetrieveArguments(string[] args, out string jsonFile, out string version)
        {
            jsonFile = "package.json";
            version = "99.99.99";

            if (args.Count () < 1 || args.Count() > 2) throw new ArgumentException("Incorrect nr of parameters specified, specify filename and/or version!");
        ...
        public static bool ReplaceVersionForArcelorMittalPackages(string jsonFile , string version)
        {
            ...
            try
            {
                ...
                if(jsonObj["name"].StartsWith("@arcelormittal-frontend/"))
                {
